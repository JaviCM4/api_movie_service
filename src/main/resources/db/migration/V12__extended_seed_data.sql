...
-- -------------------------
-- MOVIE_COMMENT
-- user_id simulados (UUIDs fijos para pruebas)
-- -------------------------
INSERT INTO movie_comment (id, movie_id, user_id, content, created_at, updated_at) VALUES
    -- Inception
    ('66666666-0012-0012-0012-000000000001', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000001', 'Una obra maestra del cine moderno. La trama te mantiene al filo del asiento.', NOW() - INTERVAL '10 days', NULL),
    ('66666666-0012-0012-0012-000000000002', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000002', 'Increíble película, aunque la primera vez no entendí el final.', NOW() - INTERVAL '5 days', NOW() - INTERVAL '4 days'),
    ('66666666-0012-0012-0012-000000000003', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000003', 'Nolan en su mejor momento. Los efectos visuales son alucinantes.', NOW() - INTERVAL '2 days', NULL),
    -- The Matrix
    ('66666666-0012-0012-0012-000000000004', 'ffffffff-0006-0006-0006-000000000002', 'user0001-0000-0000-0000-000000000001', 'Revolucionó la ciencia ficción. Keanu Reeves nació para este papel.', NOW() - INTERVAL '8 days', NULL),
    ('66666666-0012-0012-0012-000000000005', 'ffffffff-0006-0006-0006-000000000002', 'user0001-0000-0000-0000-000000000004', 'Las escenas de acción con bullet time siguen siendo épicas.', NOW() - INTERVAL '3 days', NULL),
    -- The Dark Knight
    ('66666666-0012-0012-0012-000000000006', 'ffffffff-0006-0006-0006-000000000003', 'user0001-0000-0000-0000-000000000002', 'Heath Ledger como el Joker es la actuación del siglo.', NOW() - INTERVAL '15 days', NOW() - INTERVAL '14 days'),
    ('66666666-0012-0012-0012-000000000007', 'ffffffff-0006-0006-0006-000000000003', 'user0001-0000-0000-0000-000000000003', 'La mejor película de superhéroes jamás hecha. Sin discusión.', NOW() - INTERVAL '7 days', NULL),
    -- Interstellar
    ('66666666-0012-0012-0012-000000000008', 'ffffffff-0006-0006-0006-000000000004', 'user0001-0000-0000-0000-000000000001', 'La escena del agujero negro me dejó sin palabras. Hans Zimmer épico.', NOW() - INTERVAL '20 days', NULL),
    ('66666666-0012-0012-0012-000000000009', 'ffffffff-0006-0006-0006-000000000004', 'user0001-0000-0000-0000-000000000005', 'Científicamente precisa y emocionalmente devastadora.', NOW() - INTERVAL '1 day', NULL),
    -- Se7en
    ('66666666-0012-0012-0012-000000000010', 'ffffffff-0006-0006-0006-000000000005', 'user0001-0000-0000-0000-000000000004', 'El final más perturbador que he visto en mi vida.', NOW() - INTERVAL '30 days', NULL),
    -- Titanic
    ('66666666-0012-0012-0012-000000000011', 'ffffffff-0006-0006-0006-000000000006', 'user0001-0000-0000-0000-000000000005', 'Clásico eterno. La historia de amor más trágica del cine.', NOW() - INTERVAL '12 days', NULL),
    ('66666666-0012-0012-0012-000000000012', 'ffffffff-0006-0006-0006-000000000006', 'user0001-0000-0000-0000-000000000003', 'Sí había espacio en la tabla para los dos.', NOW() - INTERVAL '6 days', NOW() - INTERVAL '5 days'),
    -- Forrest Gump
    ('66666666-0012-0012-0012-000000000013', 'ffffffff-0006-0006-0006-000000000007', 'user0001-0000-0000-0000-000000000002', 'Tom Hanks debería ganar todos los Oscars del mundo por este papel.', NOW() - INTERVAL '25 days', NULL),
    -- Avengers: Endgame (comentarios desactivados — allow_comments = FALSE, pero los datos históricos existen)
    ('66666666-0012-0012-0012-000000000014', 'ffffffff-0006-0006-0006-000000000008', 'user0001-0000-0000-0000-000000000001', 'El cierre perfecto para 11 años de Marvel. Lloré tres veces.', NOW() - INTERVAL '40 days', NULL);
...
INSERT INTO movie_rating (id, movie_id, user_id, score, created_at) VALUES
    -- Inception
    ('77777777-0013-0013-0013-000000000001', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000001', 5, NOW() - INTERVAL '10 days'),
    ('77777777-0013-0013-0013-000000000002', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000002', 5, NOW() - INTERVAL '5 days'),
    ('77777777-0013-0013-0013-000000000003', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000003', 4, NOW() - INTERVAL '2 days'),
    ('77777777-0013-0013-0013-000000000004', 'ffffffff-0006-0006-0006-000000000001', 'user0001-0000-0000-0000-000000000004', 5, NOW() - INTERVAL '1 day'),
    -- The Matrix
    ('77777777-0013-0013-0013-000000000005', 'ffffffff-0006-0006-0006-000000000002', 'user0001-0000-0000-0000-000000000001', 5, NOW() - INTERVAL '8 days'),
    ('77777777-0013-0013-0013-000000000006', 'ffffffff-0006-0006-0006-000000000002', 'user0001-0000-0000-0000-000000000002', 4, NOW() - INTERVAL '3 days'),
    ('77777777-0013-0013-0013-000000000007', 'ffffffff-0006-0006-0006-000000000002', 'user0001-0000-0000-0000-000000000005', 5, NOW() - INTERVAL '1 day'),
    -- The Dark Knight
    ('77777777-0013-0013-0013-000000000008', 'ffffffff-0006-0006-0006-000000000003', 'user0001-0000-0000-0000-000000000001', 5, NOW() - INTERVAL '15 days'),
    ('77777777-0013-0013-0013-000000000009', 'ffffffff-0006-0006-0006-000000000003', 'user0001-0000-0000-0000-000000000003', 5, NOW() - INTERVAL '7 days'),
    ('77777777-0013-0013-0013-000000000010', 'ffffffff-0006-0006-0006-000000000003', 'user0001-0000-0000-0000-000000000004', 4, NOW() - INTERVAL '2 days'),
    -- Interstellar
    ('77777777-0013-0013-0013-000000000011', 'ffffffff-0006-0006-0006-000000000004', 'user0001-0000-0000-0000-000000000001', 5, NOW() - INTERVAL '20 days'),
    ('77777777-0013-0013-0013-000000000012', 'ffffffff-0006-0006-0006-000000000004', 'user0001-0000-0000-0000-000000000002', 4, NOW() - INTERVAL '10 days'),
    ('77777777-0013-0013-0013-000000000013', 'ffffffff-0006-0006-0006-000000000004', 'user0001-0000-0000-0000-000000000005', 5, NOW() - INTERVAL '1 day'),
    -- Se7en
    ('77777777-0013-0013-0013-000000000014', 'ffffffff-0006-0006-0006-000000000005', 'user0001-0000-0000-0000-000000000002', 5, NOW() - INTERVAL '30 days'),
    ('77777777-0013-0013-0013-000000000015', 'ffffffff-0006-0006-0006-000000000005', 'user0001-0000-0000-0000-000000000004', 4, NOW() - INTERVAL '5 days'),
    -- Titanic
    ('77777777-0013-0013-0013-000000000016', 'ffffffff-0006-0006-0006-000000000006', 'user0001-0000-0000-0000-000000000003', 5, NOW() - INTERVAL '12 days'),
    ('77777777-0013-0013-0013-000000000017', 'ffffffff-0006-0006-0006-000000000006', 'user0001-0000-0000-0000-000000000005', 3, NOW() - INTERVAL '6 days'),
    -- Forrest Gump
    ('77777777-0013-0013-0013-000000000018', 'ffffffff-0006-0006-0006-000000000007', 'user0001-0000-0000-0000-000000000001', 5, NOW() - INTERVAL '25 days'),
    ('77777777-0013-0013-0013-000000000019', 'ffffffff-0006-0006-0006-000000000007', 'user0001-0000-0000-0000-000000000003', 5, NOW() - INTERVAL '8 days'),
    ('77777777-0013-0013-0013-000000000020', 'ffffffff-0006-0006-0006-000000000007', 'user0001-0000-0000-0000-000000000004', 4, NOW() - INTERVAL '3 days'),
    -- Avengers: Endgame
    ('77777777-0013-0013-0013-000000000021', 'ffffffff-0006-0006-0006-000000000008', 'user0001-0000-0000-0000-000000000002', 4, NOW() - INTERVAL '40 days'),
    ('77777777-0013-0013-0013-000000000022', 'ffffffff-0006-0006-0006-000000000008', 'user0001-0000-0000-0000-000000000005', 5, NOW() - INTERVAL '20 days');
