...
public class CommentServiceImplementation implements CommentService {
    ...
    @Override
    @Transactional
    public CommentResponse createComment(UUID movieId, CreateCommentRequest dto) throws ResourceNotFoundException {
    ...
    public List<CommentResponse> findCommentsByMovie(UUID movieId) throws ResourceNotFoundException {
        if (!movieRepository.existsById(movieId)) {
            throw new ResourceNotFoundException("Mov ie not found with id: " + movieId);
        }
